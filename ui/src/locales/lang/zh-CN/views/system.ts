export default {
  ...
  theme: {
    ...
    defaultSlogan: '欢迎使用 LLM-Know 智能知识库问答系统',
    logoDefaultTip: '默认为 LLM-Know 登录界面，支持自定义设置',
    defaultTip: '默认为 LLM-Know 平台界面，支持自定义设置',
  ...
  aiTemplate: {
    title: 'AI模板设置',
    description: '仅管理员账号 admin 可上传平台使用的 AI 模板。',
    uploadButton: '上传模板',
    uploadTip: '仅支持扩展名为 .mk 的文件，上传后将覆盖当前模板。',
    invalidFormat: '仅支持上传 .mk 格式的文件',
    uploadSuccess: 'AI 模板上传成功',
    deleteButton: '删除模板',
    deleteConfirm: '确认删除当前模板？删除后将无法恢复。',
    deleteSuccess: 'AI 模板删除成功',
    deleteFailed: 'AI 模板删除失败，请稍后重试。',
    noAccess: '仅管理员账号 admin 可访问此功能',
    currentTitle: '当前模板信息',
    fileName: '文件名称',
    filePath: '文件路径',
    uploadedAt: '上传时间',
