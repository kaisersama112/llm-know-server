export default {
  ...
  theme: {
    ...
    defaultTip: 'The default is the LLM-Know platform interface, supports custom settings',
    logoDefaultTip: 'The default is the LLM-Know login interface, supports custom settings',
  ...
  aiTemplate: {
    title: 'AI Template Settings',
    description: 'Only the admin account can upload the AI template used by the platform.',
    uploadButton: 'Upload Template',
    uploadTip: 'Only .mk files are supported. Uploading a new file overwrites the existing template.',
    invalidFormat: 'Only .mk files are allowed',
    uploadSuccess: 'AI template uploaded successfully',
    deleteButton: 'Delete Template',
    deleteConfirm: 'Delete the current template? This action cannot be undone.',
    deleteSuccess: 'AI template deleted successfully',
    deleteFailed: 'Failed to delete the AI template. Please try again later.',
    noAccess: 'Only the admin account can access this feature',
    currentTitle: 'Current Template',
    fileName: 'File Name',
    filePath: 'File Path',
